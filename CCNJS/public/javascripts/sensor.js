...
templates['sensor.hbs'] = template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"expandbox sensor\" data-id=\"pulse\">\n    <div class=\"info\">\n        <div class=\"preview\">\n            <div class=\"icon\">\n                <div class=\""
    ...
    + "\n                </div>\n                <span class=\"status\">Status: OK</span>\n            </div>\n        </div>\n        <div class=\"details\">\n          <div class=\"graph-area\">\n          </div>\n        </div>\n        <div class=\"more-info users-info expand-details\" data-id=\""
    ...
    + "\" data-key=\""
    + alias4(((helper = (helper = helpers.sensorKey || (depth0 != null ? depth0.sensorKey : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"sensorKey","hash":{},"data":data}) : helper)))
    + "\">\n            <div class=\"arrow\"></div>\n        </div>\n    </div>\n</div>\n";
},"useData":true});
})();